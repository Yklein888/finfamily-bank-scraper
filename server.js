...
// Try to load @sparticuz/chromium for Chrome binary, fallback to env var
let chromium = null;
try {
  chromium = require('@sparticuz/chromium');
} catch (e) {
  console.log('Note: @sparticuz/chromium not available, using PUPPETEER_EXECUTABLE_PATH env var');
}
...
app.get('/providers', (req, res) => {
  res.json({
    banks: [
      { id: 'hapoalim', name: 'Bank Hapoalim', logo: '🏦', type: 'bank' },
      { id: 'leumi', name: 'Bank Leumi', logo: '🏦', type: 'bank' },
      { id: 'discount', name: 'Bank Discount', logo: '🏦', type: 'bank' },
      { id: 'mizrahi', name: 'Mizrahi Tefahot', logo: '🏦', type: 'bank' },
      { id: 'beinleumi', name: 'Beinleumi', logo: '🏦', type: 'bank' },
    ],
    creditCards: [
      { id: 'isracard', name: 'Isracard', logo: '💳', type: 'credit' },
      { id: 'cal', name: 'Cal', logo: '💳', type: 'credit' },
      { id: 'max', name: 'Max', logo: '💳', type: 'credit' },
      { id: 'visaCal', name: 'Visa Cal', logo: '💳', type: 'credit' },
      { id: 'amex', name: 'Amex', logo: '💳', type: 'credit' },
    ]
  });
});
